  ...
  <div class="language-selector-wrapper">
    ...
    <div class="language-selector dropdown js-dropdown">
      {foreach from=$languages item=language}
        {if $language.id_lang == $current_language.id_lang}<span class="expand-more hidden-sm-down" data-toggle="dropdown">{$language.iso_code}</span>{/if}
      {/foreach}
      ...
      <ul class="dropdown-menu hidden-sm-down">
        {foreach from=$languages item=language}
          <li {if $language.id_lang == $current_language.id_lang} class="current selected" {/if}>
