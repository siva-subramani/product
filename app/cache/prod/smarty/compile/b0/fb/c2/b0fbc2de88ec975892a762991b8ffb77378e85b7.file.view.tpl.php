<?php /* Smarty version Smarty-3.1.19, created on 2017-01-30 21:42:30
         compiled from "/var/www/html/admin497v4911x/themes/default/template/controllers/search/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1723989425588ff996195414-44843741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0fbc2de88ec975892a762991b8ffb77378e85b7' => 
    array (
      0 => '/var/www/html/admin497v4911x/themes/default/template/controllers/search/helpers/view/view.tpl',
      1 => 1483462345,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1723989425588ff996195414-44843741',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_588ff9961de5a0_45340679',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_588ff9961de5a0_45340679')) {function content_588ff9961de5a0_45340679($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['query']->value) {?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['nb_results']->value)&&$_smarty_tpl->tpl_vars['nb_results']->value==0) {?>
		<h2><?php echo smartyTranslate(array('s'=>'There are no results matching your query "%s".','sprintf'=>array($_smarty_tpl->tpl_vars['query']->value)),$_smarty_tpl);?>
</h2>
	<?php } elseif (isset($_smarty_tpl->tpl_vars['nb_results']->value)&&$_smarty_tpl->tpl_vars['nb_results']->value==1) {?>
		<?php echo smartyTranslate(array('s'=>'1 result matches your query "%s".','sprintf'=>array($_smarty_tpl->tpl_vars['query']->value)),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['query']->value&&isset($_smarty_tpl->tpl_vars['nb_results']->value)&&$_smarty_tpl->tpl_vars['nb_results']->value) {?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d features','sprintf'=>array(count($_smarty_tpl->tpl_vars['features']->value))),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->tpl_vars['val']->value['value'];?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d modules','sprintf'=>array(count($_smarty_tpl->tpl_vars['modules']->value))),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->tpl_vars['module']->value->description;?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d categories','sprintf'=>array(count($_smarty_tpl->tpl_vars['categories']->value))),$_smarty_tpl);?>
...
?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d products','sprintf'=>array(count($_smarty_tpl->tpl_vars['products']->value))),$_smarty_tpl);?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d customers','sprintf'=>array($_smarty_tpl->tpl_vars['customerCount']->value)),$_smarty_tpl);?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d orders','sprintf'=>array(count($_smarty_tpl->tpl_vars['orders']->value))),$_smarty_tpl);?>
	...
	<div class="panel">
		<h3>
			...
			<?php } else { ?>
				<?php echo smartyTranslate(array('s'=>'%d addons','sprintf'=>array(count($_smarty_tpl->tpl_vars['addons']->value))),$_smarty_tpl);?>
