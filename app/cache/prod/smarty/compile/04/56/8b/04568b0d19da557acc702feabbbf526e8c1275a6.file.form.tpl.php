<?php /* Smarty version Smarty-3.1.19, created on 2017-01-30 22:34:02
         compiled from "/var/www/html/modules/ps_mainmenu/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204749875588ff98f845b58-26170112%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '04568b0d19da557acc702feabbbf526e8c1275a6' => 
    array (
      0 => '/var/www/html/modules/ps_mainmenu/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1485833410,
      2 => 'file',
    ),
    'c05db60f04a9d7bd0445fc9b74e0948b80f3dfd2' => 
    array (
      0 => '/var/www/html/admin497v4911x/themes/default/template/helpers/form/form.tpl',
      1 => 1483462346,
      2 => 'file',
    ),
    '6f7ec1c257c575c2786374062316a1df51123ec2' => 
    array (
      0 => '/var/www/html/admin497v4911x/themes/default/template/helpers/form/form_group.tpl',
      1 => 1483462346,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '204749875588ff98f845b58-26170112',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_588ff98fac2125_44141939',
  'variables' => 
  array (
    'fields' => 0,
    'tabs' => 0,
...
<?php if ($_valid && !is_callable('content_588ff98fac2125_44141939')) {function content_588ff98fac2125_44141939($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='link_choice') {?>
	    <div class="row">
	    	<div class="col-lg-1">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Change position','mod'=>'ps_mainmenu'),$_smarty_tpl);?>
</h4> 
	    	...
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Selected items','mod'=>'ps_mainmenu'),$_smarty_tpl);?>
</h4>
	    		<?php echo $_smarty_tpl->tpl_vars['selected_links']->value;?>

	    	</div>
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Available items','mod'=>'ps_mainmenu'),$_smarty_tpl);?>
</h4>
	    ...
	    <div class="row">
	    	...
	    	<div class="col-lg-4"><a href="#" id="removeItem" class="btn btn-default"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Remove','mod'=>'ps_mainmenu'),$_smarty_tpl);?>
</a></div>
	    	<div class="col-lg-4"><a href="#" id="addItem" class="btn btn-default"><i class="icon-arrow-left"></i> <?php echo smartyTranslate(array('s'=>'Add','mod'=>'ps_mainmenu'),$_smarty_tpl);?>
</a></div>
	    </div>
	<?php } else { ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '204749875588ff98f845b58-26170112');
content_589005aabb7716_22769336($_smarty_tpl);
...
function add()
{
	$("#availableItems option:selected").each(function(i){
		...
		if (val == "PRODUCT")
		{
			val = prompt('<?php echo smartyTranslate(array('s'=>"Indicate the ID number for the product",'mod'=>'ps_mainmenu','js'=>1),$_smarty_tpl);?>
');
			if (val == null || val == "" || isNaN(val))
				return;
			text = '<?php echo smartyTranslate(array('s'=>"Product ID #",'mod'=>'ps_mainmenu','js'=>1),$_smarty_tpl);?>
'+val;
			val = "PRD"+val;
		}
...
function move(up)
{
        ...
        if (tomove.length >1)
        {
                alert('<?php echo smartyTranslate(array('s'=>"Please select just one item",'mod'=>'ps_mainmenu'),$_smarty_tpl);?>
');
                return false;
        }
        if (up)
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-01-30 22:34:02
         compiled from "/var/www/html/admin497v4911x/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_589005aabb7716_22769336')) {function content_589005aabb7716_22769336($_smarty_tpl) {?>
